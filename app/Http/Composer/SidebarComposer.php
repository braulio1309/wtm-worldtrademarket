        ...
        $menu = [
            ...
            /*[
                ...
                'subMenu' => [
                    ...
                    [
                        'name' => trans('custom.loader'),
                        'url' => request()->root() . '/loader',
                        'permission' => auth()->user()->can('view_loader'),
                    ],
					[
            ...
            /*[
                ...
                'subMenu' => [
                    ...
                    [
                        'name' => trans('custom.template'),
                        'url' => request()->root() . '/template-view',
                        'permission' => auth()->user()->can('manage_template_view'),
                    ],
                    [
                        'name' => trans('custom.job-post'),
                        'url' => request()->root() . '/job-post-view',
                        'permission' => auth()->user()->can('manage_job-post_view'),
                    ],
                    [
            ...
            [
                ...
                'url' => request()->root() . '/transacciones/admin',
                'permission' => authorize_any(['view_admin']),
            ],
            [
                'icon' => 'user-check',
                'name' => 'Usuarios Referidos',
                'url' => request()->root() . '/user/referidos',
                'permission' => authorize_any(['view_default']),
            ],
            [
                'icon' => 'settings',
