            ...
            <form ref="form"
                ...
                <div class="form-group mb-0" v-if="!preloader">
                    ...
                    <div id="accordionExample" class="accordion" v-if="groupLoaded">
                        <div class="card" v-for="(permission, index) in Object.keys(userAndRoles.permissionList)" v-if="permission == 'settings' || permission == 'transaction' || permission == 'user_and_roles'"
