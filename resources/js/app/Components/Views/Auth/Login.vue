                    ...
                    <form class="sign-in-sign-up-form w-100"
                        ...
                        <div class="form-row">
                            <div class="form-group col-12 px-0">
                                <h6 class="text-center mb-0">Hola de nuevo</h6>
                                <label class="text-center d-block">Inicia sesión</label>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-12 px-0">
                        ...
                        <div
                            ...
                            <a :href="urlGenerator('/forget-password')"
                               class="bluish-text d-flex align-items-center justify-content-center justify-content-lg-end">
                                <app-icon name="lock" class="pr-2"/> Olvidé mi contraseña
                            </a>
                            <a v-if="configData.registration === 'on'" :href="urlGenerator('/user/registration')"
                               class="bluish-text d-flex align-items-center justify-content-center justify-content-lg-end">
                                <app-icon name="user" class="pr-2"/> Registrarse
                            </a>
                        </div>
                        <div class="form-row">
                            <div class="col-12">
