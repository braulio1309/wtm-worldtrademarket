                        ...
                        <div class="media border-right px-5 pr-xl-5 pl-xl-0 align-items-center user-header-media">
                            <form class="mb-0" ref="form" data-url="admin/auth/users/profile-picture"
                                ...
                                <div class="profile-pic-wrapper position-relative">
                                    ...
                                    <app-input v-else id="user_image" class="circle mx-xl-auto"
                                        :wrapper-class="'circle mx-xl-auto'" name="user_image" type="custom-file-upload"
                                        v-model="user.profile_picture" :generate-file-url="false"
                                        @change="setProfilePicture" :label="$t('change')" />
                                </div>
                            </form>
                            <div class="media-body user-info-header">
                                ...
                                <div class="social-links pt-3">
                                    <a class="mr-3" v-for="socialLink in user.socialLinks" v-if="socialLink.link"
                                    ...
                                    <div class="border-right custom">
                                        <div class="media mb-4 mb-xl-5">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p class="mb-0">{{
                                                    user.loggedInUser.contact ? user.loggedInUser.contact :
                                                        $t('not_available')
                                                }}</p>
                                            </div>
                                        </div>
                                        <div class="media mb-4 mb-xl-0">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <p class="mb-0">{{
                                                    user.loggedInUser.address ? user.loggedInUser.address :
                                                        $t('not_available')
                                                }}</p>
                                            </div>
                                        </div>
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
                                    ...
                                    <div class="media mb-0 mb-xl-0">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="mb-0">{{
                                                user.loggedInUser.profile ? user.loggedInUser.profile.date_of_birth :
                                                    $t('not_available')
                                            }}</p>
                                        </div>
                                    </div>
                                    <div class="media mb-0 mb-xl-0">
                                        ...
                                        <div class="media-body">
                                            <p class="text-muted mb-0">Codigo de referidos:</p>
                                            <input id="referral_code" type="text" :value="'https://wtm-dashboard.test/public/user/registration?referral_code='+referralCode" readonly>
    ...
    data() {
        return {
            ...
            tabs: [
                ...
                {
                    'name': 'Métodos de retiro',
                    'title': 'Métodos de retiro',
                    'component': 'metodo-retiro',
                    'permission': ''
                }
            ]
        }
